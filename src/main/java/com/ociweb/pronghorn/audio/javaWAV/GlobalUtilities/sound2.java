...
public class sound2 {
    ...
    public boolean save() {
        byte[] myData = new byte[Integer.MAX_VALUE]; // *** added 
        try {
    ...
    public void playWav(String filePath) {
        try {
            ...
            Logger.getLogger(sound2.class.getName()).log(Level.SEVERE, null, e);
        }
...
// ===========================
    ...
    public static int byteArrayToInt(byte[] b) {
      ...
      //  b[2] = (byte) ((high >> 16) & 0x000000FF);
       // b[3] = (byte) ((high >> 24) & 0x000000FF);
       // return (int) b;
    }
    ...
    public static byte[] intToByteArray(int data) {
        return new byte[]{(byte) (data & 0xffff), (byte) ((data >>> 16) & 0xffff)};
    }
